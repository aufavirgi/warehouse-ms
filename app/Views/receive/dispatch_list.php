<?= $this->extend('layout/page_layout_dispatcher') ?>
                ...
                <div class="row align-items-center">
                    <div class="col-md-4 col-lg-3">
                        <div class="nav flex-column nav-pills">
                            ...
                            <a href="#v-pills-completed" data-toggle="pill" class="nav-link">Dispatch Completed</a>
                        </div>
                    </div>
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="<?= base_url('receive/dispatchpickingup/'.$row->tr_id); ?>"
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="<?= base_url('receive/dispatchdelivering/'.$row->tr_id); ?>"
                                                                    class="btn mb-1 btn-warning btn-sm"
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="<?= base_url('receive/dispatching/'.$row->tr_id); ?>"
                                                                    class="btn mb-1 btn-warning btn-sm"
